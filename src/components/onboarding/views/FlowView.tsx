...
const MEDIA_RESOURCES: Record<
  string,
  { title: string; type: "video" | "audio" | "image"; src: string }
> = {
  asn: {
    title: "Cómo crear un ASN",
    type: "video",
    src: "https://www.youtube.com/embed/y7goZ96k0eY?autoplay=1&rel=0",
  },
  box: {
    title: "Cómo crear una caja",
    type: "video",
    src: "https://www.youtube.com/embed/doRO4KPgpFo?autoplay=1&rel=0",
  },
  tracker: {
    title: "Explicación de Tracker",
    type: "video",
    src: "https://www.youtube.com/embed/4yXZkSGDvDs",
  },
  labels: {
    title: "Cómo Enviar labels",
    type: "video",
    src: "https://www.youtube.com/embed/Ox7jbakLZK8",
  },
  compare_tracking: {
    title: "ASN REPORT",
    type: "video",
    src: "https://www.youtube.com/embed/HiEPR1qTa6E",
  },
  warehouse_camilo: {
    title: "Video del Warehouse - Camilo",
    type: "video",
    src: "https://www.youtube.com/embed/0MqtGJ3c_pY",
  },
  ari_returns: {
    title: "Video del Warehouse - Ari",
    type: "video",
    src: "https://www.youtube.com/embed/pfeDuQki4rA",
  },
  two_boxes: {
    title: "Video del Warehouse - Two Boxes",
    type: "video",
    src: "https://www.youtube.com/embed/XWj_OOqt8-s",
  },
  audio_camilo: {
    title: "Perspectiva de Camilo - Audio",
    type: "video",
    src: "https://www.youtube.com/embed/89CBuovfewA",
  },
  audio_samuel: {
    title: "Perspectiva de Samuel - Audio",
    type: "video",
    src: "https://www.youtube.com/embed/xeYgRup3cC4",
  },
  audio_nai: {
    title: "Perspectiva de Nai - Audio",
    type: "video",
    src: "https://www.youtube.com/embed/t3X5y8-8F9Q",
  },
  audio_karen: {
    title: "Perspectiva de Karen - Audio",
    type: "video",
    src: "https://www.youtube.com/embed/FyfDM4Bkalc",
  },
  samuel_inbound: {
    title: "Video de Samuel",
    type: "video",
    src: "https://www.youtube.com/embed/tIrZr1NjnKM",
  },
  generic_warehouse: {
    title: "Video del Warehouse",
    type: "video",
  ...
  mandar_a_armar_orden: {
    ...
    type: "video",
    src: "https://www.youtube.com/embed/g4vjzUgvAqs",
  },
  caja_armada_ejemplo: {
    title: "Ejemplo",
    type: "image",
  ...
  Armar_Caja: {
    title: "Armar_Caja",
    type: "video",
    src: "https://www.youtube.com/embed/FxI_5ndlJ_k", // Video operativo outbound
  },
  Armar_Caja_Boutique: {
    title: "Armar_Caja_Boutique",
    type: "video",
    src: "https://www.youtube.com/embed/Nn03MGUuBvY", // Video operativo outbound
  },
  crossDockGuide: {
...
const STAGES: Stage[] = [
    ...
    activities: [
      {
        ...
        blocks: [
          { type: "text", content: "La marca envía mail con tracking # + Packing List." },
          {
            type: "text",
            content:
              " Con este documento creamos el ASN = significa Advanced Shipping Notice (Aviso de Envío Anticipado) ",
          },
          { type: "button", action: "asn", content: "Como crear un ASN" },
          {
            type: "text",
            content:
              "Y también creamos las CAJAS en Mintsoft. Para que el warehouse sepa cuantas cajas hay en el cargamento.",
          },
          { type: "button", action: "box", content: "Como crear una caja" },
          {
            type: "text",
            content:
              "Lo ideal es cargarlo antes de que la mercadería llegue al warehouse para avisarle al sistema y al equipo de Dallas que hay un cargamento próximo a llegar.",
          },
        ],
      },
      {
        ...
        detail:
          "Cada marca tiene su tracker donde ponemos la información de las órdenes y los cargamentos. Una vez generado el ASN debemos anotarlo en la hoja de cargamentos (ASN# +tracking, unidades, caja y ETA).",
        ...
        blocks: [
          {
            type: "text",
            content:
              "Una vez que se recibe la foto de Camilo por el grupo, anotamos  el numero de tracking and hacemos el envío de las carton labes (email INBOUND con el nombre de la marca, el número de cargamento y carton labels). Si hay cajas faltantes esperar a que llegue el restante y hablar con la marca si hace falta.",
          },
          {
            type: "button",
            action: "labels",
      ...
      },
      {
        ...
        detail:
          "Se compara las unidades  fisicas contra el ASN cargado en sistema.  Una vez que finaliza el escaneo, se le envía a la marca el ASN REPORT.",
  ...
  },
  {
    ...
    activities: [
        ...
        blocks: [
          {
            type: "text",
            content:
              "Las órdenes pueden recibirse por distintas vías según la modalidad de trabajo con cada marca.",
          },
          {
            type: "text",
          ...
          },
          {
            type: "text",
            content:
              "• Migradas desde otras plataformas o sistemas integrados (por ejemplo Shipstation) la marca o sistemas externos conectados.",
          },
          {
            type: "text",
            content:
              "Una vez recibidas, todas las órdenes deben ingresarse en el Tracker para realizar su seguimiento operativo.",
          },
          {
            type: "button",
        ...
        blocks: [
          {
            type: "text",
            content:
              'Mandar a armar una orden significa solicitar al warehouse que prepare el pedido recibido por parte de la marca. Hay que cargar la orden en Mintsoft utilizando un template llamado <a href="https://docs.google.com/spreadsheets/d/1tTvWVIygN5TXWkee9eNk9JFZB5tOBS3A90u_HqixFUc/edit?gid=896359184#gid=896359184" target="_blank" rel="noopener noreferrer" style="color: #3b82f6; text-decoration: underline; font-weight: 500;">SO Mintsoft - 5411 - Subir ordenes</a>. Una vez finalizado el armado, el warehouse enviará una fotografía donde se visualizan las medidas de la caja.',
          },
          {
            type: "text",
            content:
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "text",
            content: "<strong>Órdenes de Boutique con 1 sola caja</strong>",
          },
          {
            type: "text",
            content:
          ...
          {
            type: "text",
            content: "<strong>Órdenes de Major con 1 sola caja</strong>",
          },
          {
            type: "text",
            content:
          ...
          {
            type: "text",
            content: "<strong>Órdenes Boutique / Major con más de 1 caja</strong>",
          },
          {
            type: "text",
            content:
          ...
          },
          {
            type: "text",
            content:
              "Hay órdenes de Majors que requieren una aprobación previa antes de ser despachadas. Este proceso se denomina ruteo y puede realizarse por correo electrónico o a través de un portal específico. En ambos casos, es importante dejar constancia de la solicitud de aprobación en el Tracker. ",
          },
          {
            type: "button",
    ...
    critical: [
      "Actualmente estamos atravesando un proceso de cambios operativos, por lo que esta información podrá actualizarse y modificarse en adelante.",
    ],
    phaseVar: "--phase-4",
  },
  {
    ...
    name: "Returns",
    short: "Devoluciones",
    objective: "Gestionar las devoluciones de nuestros clientes",
    responsible: "Equipo BS AS",
    ...
    activities: [
      {
        title: " RETURNS",
        detail:
          "En algunos casos, una marca puede solicitar que generes una return label para su cliente. Cuando esto sucede, deberás crearla manualmente en UPS. Para hacerlo, es importante contar con la siguiente información:",
        blocks: [
          {
            type: "text",
            content:
          ...
          {
            type: "text",
            content: " • Peso de cada caja y medidas de la caja.",
          },
          {
            type: "text",
            content:
...
const FAQS = [
  ...
  },
  {
    ...
    a: "PRIMERAS DOS LETRAS + últimos 6 dígitos del tracking + número de caja. Ejemplo: MO-468889-1.",
  },
  {
                ...
                return (
                  <div key={s.id}>
                    ...
                    >
                      ...
                      {isOpen && (
                        <StageBody stage={s} onTriggerMedia={(key) => setActiveMediaKey(key)} />
                      )}
                    </section>
      ...
      {s.id === "inbound" && (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(180deg, oklch(0.98 0.015 200) 0%, oklch(1 0 0) 100%)",
          }}
        >
          <div
          ...
          >
            <ClipboardList className="h-5 w-5" style={{ color: "oklch(0.45 0.13 200)" }} />
            <div>
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          warehouseAccent?.background ??
          `linear-gradient(180deg, oklch(from var(${s.phaseVar}) 0.97 0.02 h) 0%, var(--card) 100%)`,
      }}
    >
      ...
      <div
        ...
        style={{
          borderColor: warehouseAccent?.border ?? `oklch(from var(${s.phaseVar}) l c h / 0.2)`,
        }}
      >
        <div
          className="flex h-11 w-11 items-center justify-center rounded-xl text-white shadow-[var(--shadow-soft)]"
        ...
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-border/50 bg-card p-6 text-center shadow-md">
          ...
          {s.id === "inbound" && ( //WAREHOUSE ETAPA INBOUND EDITAR ACA
            <div className="w-full mt-3 space-y-4">
              ...
              <p className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                {s.warehouse}
              </p>
              {/* Video Camilo */}
              <button
              ...
              <div className="border-t pt-4">
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold">Perspectiva de Camilo</div>
                    <div className="text-xs text-muted-foreground">PUNTO CRITICO/ VALIDACIONES</div>
                  </div>
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                2. De acuerdo con las prioridades, Samuel retira las cajas de RS y las lleva a su
                mesa de trabajo. Luego imprime las etiquetas (labels), organiza las cajas en el
                orden correspondiente, coloca las etiquetas y comienza el proceso de escaneo.
              </div>
              ...
              <div className="border-t pt-4">
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold">Perspectiva de Samuel</div>
                    <div className="text-xs text-muted-foreground">PUNTO CRITICO/ VALIDACIONES</div>
                  </div>
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                3. Luego de que Samuel termina de escanear la mercadería se agrupa en RS TRANSIT
                para luego darse locación en su correspondiente Rack/ bin.
              </div>
          ...
          {s.id === "outbound" && ( //ACA EDITAR OUTBOUND WAREHOUSE
            <div className="w-full mt-3 space-y-4">
              ...
              <p className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                2. El warehouse empieza a armar la caja
              </p>
              <button
                type="button"
              ...
              <div className="border-t pt-4">
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold">Perspectiva de Karen</div>
                    <div className="text-xs text-muted-foreground">PUNTO CRITICO/ VALIDACIONES</div>
                  </div>
                  <span className="text-xs text-muted-foreground">▶ Audio</span>
                </button>
              ...
              <div className="border-t pt-4">
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold">Perspectiva de Nai</div>
                    <div className="text-xs text-muted-foreground">PUNTO CRITICO/ VALIDACIONES</div>
                  </div>
              ...
              <p className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                3. El warehouse termina de armar la caja
              </p>
              <button
                type="button"
              ...
              <p className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                4. Etapa PS: El warehouse (Ana) imprime durante el transcurso del día las etiquetas
                que armamos manualmente y enviamos por correo electrónico, junto con los packing
                lists y las carton labels, en caso de ser necesarias. Luego prepara las cajas,
                dejando todo listo para la llegada del camión de UPS, prevista aproximadamente entre
                las 16:00 y las 17:00 hs.
              </p>
              <p className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                5. LLega el camion de UPS y se lleva las cajas a sus destinos
              </p>
            </div>
          )}
          {s.id === "shipping" && ( //WAREHOUSE ETAPA RETURNS EDITAR ACA
            <div className="w-full mt-3 space-y-4">
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                2. Se Escanea cada prenda en Two Boxes.
              </div>
              {/* Video Ari Returns */}
              <button
                type="button"
              ...
              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                3. Realizan el Quality Check de cada prenda.
              </div>

              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                4. Cierran el return en el sistema.
              </div>

              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                5. Notifican por Slack que el proceso fue completado (con el numero de guia)
              </div>

              <div className="rounded-xl border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground text-justify">
                6. Cuando una caja se llena, se le da locación en los racks.
              </div>
            </div>
          )}
        </div>
    ...
    >
      ...
      {isImage ? (
        ...
        >
          ...
          <div className="mb-2 text-sm font-bold px-1 text-muted-foreground">{resource.title}</div>
        ...
        >
          ...
          {isAudio ? (
            <div className="flex flex-col items-center justify-center rounded-xl bg-muted/30 p-6 border border-border/40">
              ...
              <audio className="w-full h-12 accent-primary" src={resource.src} controls autoPlay />
            </div>
          ) : (
                            ...
                            {openFineline && (
                              <div className="border-t border-border p-4 space-y-4 text-sm text-muted-foreground">
                                <p className="leading-relaxed">
                                  La mayoría de las órdenes <strong>Major</strong> requieren{" "}
                                  <strong>reetiquetado (Fineline)</strong>. Esto significa que el
                                  warehouse debe reemplazar las etiquetas originales de la
                                  mercadería por las etiquetas solicitadas por la marca. Estas deben
                                  contener el barcode y toda la información requerida por el
                                  cliente.
                                </p>
                                ...
                                <div>
                                  ...
                                  <ul className="space-y-2 list-disc pl-5">
                                    ...
                                    <li>
                                      Que las etiquetas Fineline ya hayan sido recibidas en el
                                      warehouse.
                                    </li>
                                ...
                                <div className="rounded-lg border border-yellow-300 bg-yellow-50 p-4">
                                  ...
                                  <p className="text-yellow-900 leading-relaxed">
                                    Las etiquetas Fineline pueden ser enviadas por la marca o
                                    adquiridas por nuestro equipo. Independientemente de quién las
                                    provea, es fundamental anticipar su gestión para que, cuando la
                                    mercadería llegue al warehouse, las etiquetas ya se encuentren
                                    disponibles.
                                  </p>
                                  <button
                                    type="button"
